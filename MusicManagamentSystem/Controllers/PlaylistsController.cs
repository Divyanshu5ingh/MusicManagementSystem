...
namespace MusicManagamentSystem.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PlaylistsController : ControllerBase
    {
        private readonly MusicManagamentSystemContext _context;

        public PlaylistsController(MusicManagamentSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Playlist>> PostPlaylist(Playlist playlist)
        {
          if (_context.Playlist == null)
          {
              return Problem("Entity set 'MusicManagamentSystemContext.Playlist'  is null.");
          }
